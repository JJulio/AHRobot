...
// Smooth pulley for 608 bearing
// I used the same belt profiles pulley file but it will be better to simplify it
...
motor_shaft = 22.5;	// bearing diameter
...
difference()
{
	translate([0,0,1]) cylinder(r=12,h=2,$fn=16,center=true);
	translate([0,0,1]) cylinder(r=10,h=5,$fn=24,center=true);
}
