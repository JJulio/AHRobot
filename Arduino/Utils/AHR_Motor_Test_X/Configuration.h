...
#define MAX_ACCEL_X 280    //320      // Maximun motor acceleration in (steps/seg2)/1000
#define MIN_ACCEL_Y 40
#define MAX_ACCEL_Y 150    //220 
...
#define MISSING_STEPS_MAX_ERROR_Y 14
#define ROBOT_POSITION_CAMERA_CORRECTION_Y -15 // Correction of the position of the camera because the camera point of view and mark position
